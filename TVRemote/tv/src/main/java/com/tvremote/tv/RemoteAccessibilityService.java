...
public class RemoteAccessibilityService extends AccessibilityService {
    ...
    void key(int code){
        ...
        dispatchKeyEvent(new KeyEvent(n,n,KeyEvent.ACTION_DOWN,code,0));
        dispatchKeyEvent(new KeyEvent(n,n,KeyEvent.ACTION_UP,code,0));
    }
    void global(String c){
        ...
        else if(c.equals("DPAD_UP"))key(KeyEvent.KEYCODE_DPAD_UP);
        else if(c.equals("DPAD_DOWN"))key(KeyEvent.KEYCODE_DPAD_DOWN);
        else if(c.equals("DPAD_LEFT"))key(KeyEvent.KEYCODE_DPAD_LEFT);
        else if(c.equals("DPAD_RIGHT"))key(KeyEvent.KEYCODE_DPAD_RIGHT);
